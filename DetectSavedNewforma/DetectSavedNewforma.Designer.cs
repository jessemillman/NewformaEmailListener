...
namespace DetectSavedNewforma {
    ...
    public sealed partial class NewformaAddIn : Microsoft.Office.Tools.Outlook.OutlookAddInBase {
        ...
        public NewformaAddIn(global::Microsoft.Office.Tools.Outlook.Factory factory, global::System.IServiceProvider serviceProvider) : 
    ...
    internal sealed partial class Globals {
        ...
        private static NewformaAddIn _NewformaAddIn;
        ...
        internal static NewformaAddIn NewformaAddIn {
            get {
                return _NewformaAddIn;
            }
            set {
                if ((_NewformaAddIn == null)) {
                    _NewformaAddIn = value;
                }
                else {
        ...
        internal static ThisFormRegionCollection FormRegions {
            get {
                if ((_ThisFormRegionCollection == null)) {
                    _ThisFormRegionCollection = new ThisFormRegionCollection(Globals.NewformaAddIn.GetFormRegions());
                }
    ...
    internal sealed partial class ThisFormRegionCollection : Microsoft.Office.Tools.Outlook.FormRegionCollectionBase {
        ...
        internal WindowFormRegionCollection this[Microsoft.Office.Interop.Outlook.Explorer explorer] {
            get {
                return ((WindowFormRegionCollection)(Globals.NewformaAddIn.GetFormRegions(explorer, typeof(WindowFormRegionCollection))));
            }
        }
        
        internal WindowFormRegionCollection this[Microsoft.Office.Interop.Outlook.Inspector inspector] {
            get {
                return ((WindowFormRegionCollection)(Globals.NewformaAddIn.GetFormRegions(inspector, typeof(WindowFormRegionCollection))));
            }
        }
    }
